...
VALUES
    ('ncs', 'ncs', 'user3@example.com', 'John', 'Doe', true, true, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP, '1995-03-15', 5555555555, '123 Main St', 'What is your favorite color?', 'Blue', 'CUSTOMER', 0),
    ...
    ('user20', '$2a$10$eEgz5Q3U8Bxz13oLBZHzrukHZ6mJpTAUOuMdPPIkhPglJ806luJ16', 'user20@example.com', 'Laura', 'Martin', true, true, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP, '1993-06-07', 2222888899, '1515 Cedar Lane', 'What is your favorite animal?', 'Cats', 'CUSTOMER', 0);
END;