package com.secure_sentinel.accounts.accounts_service.security;
    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        ...
        http
                ...
                .authorizeHttpRequests(authz -> authz
                        .requestMatchers(apiMatcher, swaggerMatcher, apiDocsMatcher, swaggerHtmlMatcher,
                                swaggerResourcesMatcher, webjarsMatcher).permitAll()
